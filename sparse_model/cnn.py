...
class SparseLeNet(torch.nn.Module):
    ...
    def __add__(self, model):
        self.conv1.weight.data += model.conv1.weight.data
        self.conv2.weight.data += model.conv2.weight.data
        self.fc1.weight.data += model.fc1.weight.data
        self.fc2.weight.data += model.fc2.weight.data
        return self
